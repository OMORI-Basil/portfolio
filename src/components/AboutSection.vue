...
@media (max-width:768px){ .about-section { padding: 6rem 0; } .container { padding: 0 1.5rem; } .about-me-wrapper { grid-template-columns: 1fr; gap: 2.5rem; margin-bottom: 5rem; } .about-avatar { max-width: 280px; } .info-row { grid-template-columns: 1fr; gap: 1rem; } .stats-row { gap: 2rem; } .building-row { flex-direction: column; gap: 1rem; } .timeline-wrapper { display: none; } .experience-grid { grid-template-columns: 1fr; gap: 2rem; } .experience-card { padding-left: 0; } }
</style>
