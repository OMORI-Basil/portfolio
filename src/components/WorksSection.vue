...
@media (max-width:768px){ .works-section { padding: 6rem 0; } .container { padding: 0 1.5rem; } .work-row { flex-wrap: wrap; gap: .75rem 1rem; min-height: auto; padding: 1.25rem 0; } .work-num { -webkit-text-stroke-width: 1px; width: auto; font-size: 2.5rem; } .work-info { flex: 1; min-width: 60%; } .work-title { white-space: normal; } .work-date { text-align: left; order: 4; width: 100%; margin-left: 0; } }
</style>
